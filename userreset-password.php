...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($conn,"update tblregusers set Password='$password'  where  Email='$email' && MobileNumber='$contactno' ");
   if($query)
   {
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index1.php">
                       <h2 style="color: yellow">Vehicle Parking Management System</h2>
                    </a>
                </div>
