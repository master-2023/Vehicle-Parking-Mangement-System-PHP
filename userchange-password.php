...
$query1=mysqli_query($conn,"select ID from tblregusers where ID='$userid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query1);
if($row>0){
$ret=mysqli_query($conn,"update tblregusers set Password='$newpassword' where ID='$userid'");
...
<head>
    ...
    <title>PAYPARK - Change Password</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="userchange-password.php">Change Password</a></li>
